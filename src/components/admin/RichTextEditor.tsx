  ...
  const addEmbed = () => {
    if (embedUrl || embedCode) {
      ...
      if (embedCode) {
        ...
        // Generate embed based on type and URL
        switch (embedType) {
          case 'twitter':
          case 'x':
            embedHtml = `<blockquote class="twitter-tweet" data-dnt="true" data-theme="light"><p lang="en" dir="ltr"><a href="${embedUrl}">View this post on Twitter</a></p></blockquote><script async src="https://platform.twitter.com/widgets.js"></script>`;
            break;
          case 'instagram':
          ...
          case 'youtube':
            ...
            break;
          case 'tiktok':
            embedHtml = `<blockquote class="tiktok-embed" cite="${embedUrl}"><a href="${embedUrl}">View TikTok</a></blockquote><script async src="https://www.tiktok.com/embed.js"></script>`;
            break;
          case 'spotify':
            ...
            break;
          default:
            embedHtml = `<div class="embed-container">${embedUrl}</div>`;
        }
      }
